...
export class WeatherAgent {
    ...
    private messages = [
        {
            role: 'system',
            content: 'You are a weather agent that provides weather information and you can generateImage from prompt (refrain from nudity content.). Only use functions you have been provided with.'
        }
    ]
